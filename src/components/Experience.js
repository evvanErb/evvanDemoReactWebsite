...
class Experience extends Component {
    render() {
      return (
        <div className="Experience d-flex p-3 mx-auto flex-column text-center text-white bg-dark" id="experience" style={{ height: "auto", minHeight: "1030px", position: "relative" }} >
